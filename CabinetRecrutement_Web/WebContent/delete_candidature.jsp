	...
	if(id==null){
        ...
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <p>La candidature <%=candidature.getId() %> n'est désormait plus dans notre base de données</p>
	...
	%>
	 <div class="row col-xs-offset-1 col-xs-10">
	   <div class="panel panel-red">
	     ...
	     <div class="panel-body text-center">
	       <p class="text-danger"><strong>Vous n'êtes pas autorisé à supprimé des candidatures !</strong></p>
